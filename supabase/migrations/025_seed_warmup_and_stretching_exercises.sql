...
BEGIN
  ...
  INSERT INTO public.exercises (
    ...
    exercise_type, instructions, usage_tags, visibility, is_active, created_by_role, media_url
  ) VALUES (
    ...
    ARRAY['estiramiento'], 'gym', true, 'admin', 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Doorway_Chest_Stretch/0.jpg'
  ...
  INSERT INTO public.exercises (
    ...
    ARRAY['estiramiento'], 'gym', true, 'admin', 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Side_Wrist_Pull_Stretch/0.jpg'
  ) ON CONFLICT DO NOTHING;
  ...
  INSERT INTO public.exercises (
    ...
    ARRAY['estiramiento'], 'gym', true, 'admin', 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Seated_Hamstring_Stretch/0.jpg'
  ) ON CONFLICT DO NOTHING;
  ...
  INSERT INTO public.exercises (
    ...
    ARRAY['estiramiento'], 'gym', true, 'admin', 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Standing_Quadriceps_Stretch/0.jpg'
  ) ON CONFLICT DO NOTHING;
  ...
  INSERT INTO public.exercises (
    ...
    ARRAY['estiramiento'], 'gym', true, 'admin', 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Piriformis_Stretch/0.jpg'
  ) ON CONFLICT DO NOTHING;
  ...
  INSERT INTO public.exercises (
    ...
    ARRAY['estiramiento'], 'gym', true, 'admin', 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Shoulder_Stretch/0.jpg'
  ) ON CONFLICT DO NOTHING;
  ...
  INSERT INTO public.exercises (
    ...
    ARRAY['estiramiento'], 'gym', true, 'admin', 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Overhead_Triceps_Stretch/0.jpg'
  ) ON CONFLICT DO NOTHING;
  ...
  INSERT INTO public.exercises (
    ...
    ARRAY['estiramiento'], 'gym', true, 'admin', 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Butterfly/0.jpg'
  ) ON CONFLICT DO NOTHING;
  ...
  INSERT INTO public.exercises (
    ...
    ARRAY['estiramiento'], 'gym', true, 'admin', 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Cobra_Side_Stretch/0.jpg'
  ) ON CONFLICT DO NOTHING;
  ...
  INSERT INTO public.exercises (
    ...
    ARRAY['estiramiento'], 'gym', true, 'admin', 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Calf_Stretch_Hands_Against_Wall/0.jpg'
  ) ON CONFLICT DO NOTHING;
  ...
  INSERT INTO public.exercises (
    ...
    ARRAY['calentamiento'], 'gym', true, 'admin', 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Arm_Circles/0.jpg'
  ) ON CONFLICT DO NOTHING;
  ...
  INSERT INTO public.exercises (
    ...
    ARRAY['calentamiento'], 'gym', true, 'admin', 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Cat_Cow/0.jpg'
  ) ON CONFLICT DO NOTHING;
  ...
  INSERT INTO public.exercises (
    ...
    ARRAY['calentamiento'], 'gym', true, 'admin', 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lunge_With_Twist/0.jpg'
  ) ON CONFLICT DO NOTHING;
  ...
  INSERT INTO public.exercises (
    ...
    ARRAY['calentamiento'], 'gym', true, 'admin', 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Bodyweight_Squat/0.jpg'
  ) ON CONFLICT DO NOTHING;
  ...
  INSERT INTO public.exercises (
    ...
    ARRAY['calentamiento'], 'gym', true, 'admin', 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Inchworm/0.jpg'
  ) ON CONFLICT DO NOTHING;
