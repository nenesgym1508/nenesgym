  ...
  return (
    <>
      ...
      <button
        ...
        className="btn-glossy-red w-full flex items-center justify-center gap-2.5 rounded-2xl py-4 text-sm font-black uppercase tracking-wide text-white"
      >
        <Plus className="size-5" />
        <span>{isEdit ? "Modificar medición" : "Registrar nueva medición"}</span>
      </button>
